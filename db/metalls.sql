...
--
-- Database: `metotech_metalls_strip`
--
...
CREATE TABLE IF NOT EXISTS `rad_eff_coef` (
  ...
  `order` int(11) NOT NULL COMMENT 'Порядок, в котором выводить записи при отображении калькулятора',
  `heater_type` int(11) NOT NULL COMMENT 'Тип нагревателей: 1 - круглый, 2 - плоский',
  PRIMARY KEY (`id`)
...
INSERT INTO `rad_eff_coef` (`id`, `heater_placement`, `min_coef`, `max_coef`, `order`, `heater_type`) VALUES
(1, 'Проволочные спирали полузакрытые', 0.16, 0.24, 2, 1),
(2, 'Проволочные спирали на полочках в трубках', 0.3, 0.36, 3, 1),
(3, 'Проволочные зигзагообразные нагреватели', 0.6, 0.72, 4, 1),
(4, 'Проволочные спиралевидные нагреватели', 0.6, 0.72, 1, 1),
(5, 'Ленточные зигзагообразные нагреватели', 0.38, 0.44, 5, 2),
(6, 'Ленточные профилированные (ободовые) нагреватели', 0.56, 0.7, 6, 2);
